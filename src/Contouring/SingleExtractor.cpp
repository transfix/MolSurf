...
using CCVContouring::SingleExtractor;

SingleExtractor::SingleExtractor() { setDefaults(); }

SingleExtractor::~SingleExtractor() { setDefaults(); }

void SingleExtractor::extractContour(ContourGeometry *contourGeometry,
        ...
        if (cubeCase != 0 && cubeCase != 255) {
          ...
          for (edgeCounter = 0; edgeCounter < cubeedges[cubeCase][0];
            ...
            if (!cacheAvailable[edgeID]) {
              ...
              contourGeometry->addEdge(newEdge, v1x, v1y, v1z, n1x, n1y, n1z, R,
                                       G, B, v2x, v2y, v2z, n2x, n2y, n2z, R, G,
                                       B, den1, den2);
...
void SingleExtractor::setData(unsigned char *data, unsigned int width,
...
void SingleExtractor::classifyVertices(unsigned int k,
...
inline unsigned int SingleExtractor::determineCase(unsigned char *data,
...
void SingleExtractor::calcOffsets(unsigned int *offsets, unsigned int width,
                                  unsigned int height) {
