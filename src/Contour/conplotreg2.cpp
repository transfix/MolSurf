...
int Conplotreg2::InterpEdge(int edge, float *val, float isovalue, int i,
  ...
  case 0:
    ...
    pt[0] =
        (1.0f - ival) * curreg2->xCoord(i + 1) + ival * curreg2->xCoord(i + 0);
  ...
  case 1:
    ...
    pt[1] =
        (1.0f - ival) * curreg2->yCoord(j + 1) + ival * curreg2->yCoord(j + 0);
    break;
  case 2:
    ival = (isovalue - val[3]) / (val[2] - val[3]);
    pt[0] =
        (1.0f - ival) * curreg2->xCoord(i + 0) + ival * curreg2->xCoord(i + 1);
  ...
  case 3:
    ...
    pt[1] =
        (1.0f - ival) * curreg2->yCoord(j + 0) + ival * curreg2->yCoord(j + 1);
    break;
  }
