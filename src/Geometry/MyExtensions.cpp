...
#define INIT_PROC_POINTER(pointerType, procName)                               \
  procName = (pointerType)glXGetProcAddress((const GLubyte *)#procName);       \
  if (procName == 0)                                                           \
  return false
#else
...
bool MyExtensions::initExtension(const char *extension) {
  if (0 == extension) {
    ...
    INIT_PROC_POINTER(MYPFNGLBLENDEQUATIONSEPARATEPROC,
    ...
    INIT_PROC_POINTER(MYPFNGLDISABLEVERTEXATTRIBARRAYPROC,
                      glDisableVertexAttribArray);
    INIT_PROC_POINTER(MYPFNGLENABLEVERTEXATTRIBARRAYPROC,
    ...
    INIT_PROC_POINTER(MYPFNGLGETVERTEXATTRIBPOINTERVPROC,
    ...
    INIT_PROC_POINTER(MYPFNGLSECONDARYCOLOR3UBVEXTPROC,
                      glSecondaryColor3ubvEXT);
    INIT_PROC_POINTER(MYPFNGLSECONDARYCOLOR3UIEXTPROC, glSecondaryColor3uiEXT);
    INIT_PROC_POINTER(MYPFNGLSECONDARYCOLOR3UIVEXTPROC,
                      glSecondaryColor3uivEXT);
    INIT_PROC_POINTER(MYPFNGLSECONDARYCOLOR3USEXTPROC, glSecondaryColor3usEXT);
    INIT_PROC_POINTER(MYPFNGLSECONDARYCOLOR3USVEXTPROC,
                      glSecondaryColor3usvEXT);
    INIT_PROC_POINTER(MYPFNGLSECONDARYCOLORPOINTEREXTPROC,
    ...
    INIT_PROC_POINTER(MYPFNGLGETBUFFERPARAMETERIVARBPROC,
    ...
    INIT_WGL_PROC_POINTER(MYPFNWGLGETPIXELFORMATATTRIBIVARBPROC,
                          wglGetPixelFormatAttribivARB);
    INIT_WGL_PROC_POINTER(MYPFNWGLGETPIXELFORMATATTRIBFVARBPROC,
                          wglGetPixelFormatAttribfvARB);
    INIT_WGL_PROC_POINTER(MYPFNWGLCHOOSEPIXELFORMATARBPROC,
    ...
    INIT_WGL_PROC_POINTER(MYPFNWGLRELEASEPBUFFERDCARBPROC,
    ...
    INIT_WGL_PROC_POINTER(MYPFNWGLRELEASETEXIMAGEARBPROC,
                          wglReleaseTexImageARB);
    INIT_WGL_PROC_POINTER(MYPFNWGLSETPBUFFERATTRIBARBPROC,
...
const char *MyExtensions::getSystemExtensions() {
  ...
  mywglGetExtensionsStringARB =
      (MYPFNWGLGETEXTENSIONSSTRINGARBPROC)wglGetProcAddress(
          "wglGetExtensionsStringARB");
