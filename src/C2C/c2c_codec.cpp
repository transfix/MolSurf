...
void writeC2CFile(void *data, unsigned char *red, unsigned char *green,
  ...
  case 0:
  case 3: {
    cfac = new BlockFactory<unsigned char>((unsigned char *)data, red, green,
                                           blue, dim, orig, span);
    ccon = new CompCon<unsigned char>(cfac);
  ...
  case 1:
  case 4: {
    sfac = new BlockFactory<unsigned short>((unsigned short *)data, red, green,
                                            blue, dim, orig, span);
    scon = new CompCon<unsigned short>(sfac);
  ...
  case 2:
  case 5: {
    ffac = new BlockFactory<float>((float *)data, red, green, blue, dim, orig,
                                   span);
    fcon = new CompCon<float>(ffac);
