 ...
 *
 */
void arithmetic_encode(unsigned int low, unsigned int high,
                       unsigned int total) {
  unsigned long temp;
#ifndef SHIFT_ADD
  r = R / total;
 ...
 *
 */
unsigned int arithmetic_decode_target(unsigned int total) {
 ...
 *
 */
void arithmetic_decode(unsigned int low, unsigned int high,
                       unsigned int total) {
  unsigned int temp;
#ifndef SHIFT_ADD
 ...
 *
 */
void startinputtingbits(void) { bits_to_go = 0; }
 ...
 *
 */
void doneinputtingbits(void) { bits_to_go = 0; }
