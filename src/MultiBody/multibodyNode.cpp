...
bool MultiBodyNode::readInfoFile(std::string nodeFileName)
{
	...
	{
		std::cout<<"Error reading node info file. Failed to read point file name from "<< nodeFileName <<"\n";
		return false;
	}
	...
	{
		std::cout<<"Error reading node info file. Failed to surface file name from "<< nodeFileName <<"\n";
		return false;
	}
	...
	{
		std::cout<<"Error reading node info file. Failed to quad point file name from "<< nodeFileName <<"\n";
		return false;
	}
	...
	{
		std::cout<<"Error reading node info file. Failed to volume file name from "<< nodeFileName <<"\n";
		return false;
	}
...
const Score* MultiBodyNode::getScores() const
{
	return nodeScore;
}
