...
PDBParser::GroupOfAtoms *XYZFile::loadFile(const string &fileName,
                                           bool deleteWater) {
...
bool XYZFile::checkType(const string &fileName) { return false; }

bool XYZFile::saveFile(PDBParser::GroupOfAtoms *molecule,
...
GOAFileType *XYZFile::getRepresentative() { return &ms_XYZFileRepresentative; }
