...
PDBParser::GroupOfAtoms *PDBFile::loadFile(const string &fileName,
                                           bool deleteWater) {
...
bool PDBFile::checkType(const string &fileName) { return false; }

bool PDBFile::saveFile(PDBParser::GroupOfAtoms *molecule,
...
GOAFileType *PDBFile::getRepresentative() { return &ms_PDBFileRepresentative; }
