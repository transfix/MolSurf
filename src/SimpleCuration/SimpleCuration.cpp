  ...
  for (int i = 0; i < nVert; i++) {
    if (comp[i] >= 0) {
      ...
      if (inGeom->m_TriVertNormals) {
        outGeom->m_TriVertNormals[3 * j + 0] =
            inGeom->m_TriVertNormals[3 * i + 0];
        outGeom->m_TriVertNormals[3 * j + 1] =
            inGeom->m_TriVertNormals[3 * i + 1];
        outGeom->m_TriVertNormals[3 * j + 2] =
            inGeom->m_TriVertNormals[3 * i + 2];
      }
      if (inGeom->m_TriVertColorsTransparent) {
        outGeom->m_TriVertColorsTransparent[4 * j + 0] =
            inGeom->m_TriVertColorsTransparent[4 * i + 0];
        outGeom->m_TriVertColorsTransparent[4 * j + 1] =
            inGeom->m_TriVertColorsTransparent[4 * i + 1];
        outGeom->m_TriVertColorsTransparent[4 * j + 2] =
            inGeom->m_TriVertColorsTransparent[4 * i + 2];
        outGeom->m_TriVertColorsTransparent[4 * j + 3] =
            inGeom->m_TriVertColorsTransparent[4 * i + 3];
      }
