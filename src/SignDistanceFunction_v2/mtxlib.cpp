...
// Return Normal of vector2s
vector2 Normalized(const vector2 &a) {
  vector2 ret(a);
  return ret.normalize();
}
// Return Normal of vector3s
vector3 Normalized(const vector3 &a) {
  vector3 ret(a);
  return ret.normalize();
}
// Return Normal of vector4s
...
// Are these two vector2s nearly equal?
