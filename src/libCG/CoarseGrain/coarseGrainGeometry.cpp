...
void CoarseGrain::atomClustering(GroupOfAtoms *GroupOfBeads, int head,
                                 int tail) {
...
void CoarseGrain::generateBackboneBead(GroupOfAtoms *GroupOfBeads, int head,
                                       int tail) {
  char resName[5];
...
void CoarseGrain::generateARGBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "ARG");
  int resSeq = molecule->m_Atoms[head]->resSeq;
  ...
  for (i = head; i <= tail; i++) {
    if (!isBackboneAtom(i)) {
      ...
      if (strstr(atomName, "B") != NULL || strstr(atomName, "G") != NULL) {
...
void CoarseGrain::generateGLNBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "GLN");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateGLUBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "GLU");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateHISBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "HIS");
  int resSeq = molecule->m_Atoms[head]->resSeq;
  ...
  for (i = head; i <= tail; i++) {
    if (!isBackboneAtom(i)) {
      ...
      strcpy(atomName, molecule->m_Atoms[i]->atomName);
      if (strstr(atomName, "B") != NULL || strstr(atomName, "G") != NULL ||
          strstr(atomName, "ND1") != NULL || strstr(atomName, "HD1") != NULL) {
        SidechainList1.push_back(i);
      } else {
        SidechainList2.push_back(i);
      }
...
void CoarseGrain::generateLYSBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "LYS");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateMETBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "MET");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generatePHEBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "PHE");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateTRPBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "TRP");
  int resSeq = molecule->m_Atoms[head]->resSeq;
  ...
  for (i = head; i <= tail; i++) {
    if (!isBackboneAtom(i)) {
      ...
      strcpy(atomName, molecule->m_Atoms[i]->atomName);
      if (strstr(atomName, "B") != NULL || strstr(atomName, "G") != NULL ||
          strstr(atomName, "D1") != NULL || strstr(atomName, "E1") != NULL) {
        SidechainList1.push_back(i);
      } else {
        SidechainList2.push_back(i);
      }
...
void CoarseGrain::generateTYRBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "TYR");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateGLYBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "GLY");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateVALBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "VAL");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateLEUBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "LEU");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateILEBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "ILE");
  int resSeq = molecule->m_Atoms[head]->resSeq;
  ...
  for (i = head; i <= tail; i++) {
    if (!isBackboneAtom(i)) {
      char atomName[10];
      strcpy(atomName, molecule->m_Atoms[i]->atomName);
      if (strstr(atomName, "B") != NULL || strstr(atomName, "G2") != NULL) {
        SidechainList1.push_back(i);
      } else {
        SidechainList2.push_back(i);
      }
...
void CoarseGrain::generateASNBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "ASN");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateASPBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "ASP");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateALABead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "ALA");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateSERBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "SER");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateTHRBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "THR");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateCYSBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "CYS");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generatePROBead(GroupOfAtoms *GroupOfBeads, int head,
                                  int tail) {
  char resName[5];
  strcpy(resName, "PRO");
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
void CoarseGrain::generateNormalBead(GroupOfAtoms *GroupOfBeads, int head,
                                     int tail) {
  char resName[5];
  strcpy(resName, molecule->m_Atoms[head]->resName);
  int resSeq = molecule->m_Atoms[head]->resSeq;
...
bool CoarseGrain::isBackboneAtom(int a) {
  ...
  if (strcmp(atomName, " N  ") == 0 || strcmp(atomName, " CA ") == 0 ||
      strcmp(atomName, " C  ") == 0 || strcmp(atomName, " O  ") == 0 ||
      strcmp(atomName, " H  ") == 0 || strcmp(atomName, " HA ") == 0 ||
      strcmp(atomName, " H2 ") == 0 || strcmp(atomName, " H3 ") == 0) {
    return true;
  } else {
    return false;
  }
...
void CoarseGrain::getGeometryCenter(int *AtomList, double *coord,
                                    int numOfChild) {
  int i;
  double c[3];
  c[0] = c[1] = c[2] = 0.0;
...
double CoarseGrain::getInitialRadius(int *AtomList, double *center,
                                     int numOfChild) {
  int i;
