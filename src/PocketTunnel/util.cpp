...
bool is_inf_VF(const Triangulation &triang, const Cell_handle &c, const int uid,
               const int vid) {
...
// Compute the cosine of the smaller of the two angles made by the vectors v and
// w
