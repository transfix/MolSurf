...
bool Ray::intersectSphere(Vector center, float radius, Vector *point1,
  ...
  float A = m_Dir[0] * m_Dir[0] + m_Dir[1] * m_Dir[1] + m_Dir[2] * m_Dir[2];
...
void Ray::print() {
  printf("[%5.3lf %5.3lf %5.3lf %5.3lf ] [%5.3lf %5.3lf %5.3lf %5.3lf ]\n",
         m_Origin[0], m_Origin[1], m_Origin[2], m_Origin[3], m_Dir[0], m_Dir[1],
         m_Dir[2], m_Dir[3]);
}
