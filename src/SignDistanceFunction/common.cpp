...
int SDFLibrary::index2cell(int i, int j, int k) {
  return (k * (SDFLibrary::size) * (SDFLibrary::size) + j * (SDFLibrary::size) +
          i);
}
...
void SDFLibrary::object2octree(double xmin, double ymin, double zmin,
  ...
  int i = (int)((xmax - SDFLibrary::minext[0]) / (SDFLibrary::span[0]));
  ci = (i + ci) / 2;
  cj = (int)((ymin - SDFLibrary::minext[1]) / (SDFLibrary::span[1]));
  int j = (int)((ymax - SDFLibrary::minext[1]) / (SDFLibrary::span[1]));
  cj = (j + cj) / 2;
  ck = (int)((zmin - SDFLibrary::minext[2]) / (SDFLibrary::span[2]));
  int k = (int)((zmax - SDFLibrary::minext[2]) / (SDFLibrary::span[2]));
  ck = (k + ck) / 2;
