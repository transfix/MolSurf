...
void re_orient_all() {
  ...
  int inside_point = -1;
  double err, dist;
  // double lamda = -0.5; //The dist that the pt is going to be moved inside the
  ...
  closestTri = i;
  // The closest distance 'tween the surface[closesetTri] and the Origin is only
  // the distance of the plane from O
