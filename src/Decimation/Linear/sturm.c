...
static int near sturm1(double *p, int n, double a, double b, double tol,
                       double *rwk, int *iwk);
static void near sturm0(double a, double pa, int ia, double b, double pb,
                        int ib);
...
static int near sturm_remainder(int n0, double *p0, int n1, double *p1,
                                double *p2);
static double near poly_eval(register int n, double *p, double x);
static int near sturm_ncis(double x, double *px);

int sturm(double *p, int n, double a, double b, double tol, double *rwk,
          int *iwk)
/*-------------------------------------------------------------------------
...
#ifdef NEWTON
static int near sturm_newton(int n, double *p, double *pprime, double *x,
