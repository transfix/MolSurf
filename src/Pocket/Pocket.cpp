...
// ...from a GOA
void Pocket::constructPockets(PDBParser::GroupOfAtoms *goa, string fileName,
                              float distance, Geometry **pocketGeometry,
                              int size) {
...
// ...from a Geometry
void Pocket::constructPockets(Geometry *geometry, string fileName,
                              float distance, Geometry **pocketGeometry,
                              int size) {
