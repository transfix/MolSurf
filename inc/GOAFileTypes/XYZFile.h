...
*/
#ifndef CCV_XYZ_FILE_H
#define CCV_XYZ_FILE_H
...
class XYZFile : public GOAFileType {
public:
  virtual ~XYZFile();
  ...
  virtual string extension() { return "xyz"; };
  virtual string filter() { return "XYZ files (*.xyz)"; };
  static XYZFile ms_XYZFileRepresentative;
