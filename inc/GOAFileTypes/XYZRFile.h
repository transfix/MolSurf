...
*/
#ifndef CCV_XYZR_FILE_H
#define CCV_XYZR_FILE_H
...
class XYZRFile : public GOAFileType {
public:
  virtual ~XYZRFile();
  ...
  virtual string extension() { return "xyzr"; };
  virtual string filter() { return "XYZR files (*.xyzr)"; };
  static XYZRFile ms_XYZRFileRepresentative;
