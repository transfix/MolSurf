...
*/
#ifndef CCV_PTS_FILE_H
#define CCV_PTS_FILE_H
...
class PTSFile : public GOAFileType {
public:
  virtual ~PTSFile();
  ...
  virtual string extension() { return "pts"; };
  virtual string filter() { return "PTS files (*.pts)"; };
  static PTSFile ms_PTSFileRepresentative;
