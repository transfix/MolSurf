...
typedef void(APIENTRY *MYPFNGLDRAWRANGEELEMENTSPROC)(GLenum mode, GLuint start,
...
typedef void(APIENTRY *MYPFNGLCOLORTABLEPARAMETERFVPROC)(GLenum target,
                                                         GLenum pname,
...
typedef void(APIENTRY *MYPFNGLCONVOLUTIONPARAMETERIPROC)(GLenum target,
                                                         GLenum pname,
                                                         GLint params);
typedef void(APIENTRY *MYPFNGLCONVOLUTIONPARAMETERIVPROC)(GLenum target,
                                                          GLenum pname,
                                                          const GLint *params);
...
typedef void(APIENTRY *MYPFNGLGETCONVOLUTIONPARAMETERIVPROC)(GLenum target,
                                                             GLenum pname,
                                                             GLint *params);
typedef void(APIENTRY *MYPFNGLGETSEPARABLEFILTERPROC)(GLenum target,
                                                      GLenum format,
...
typedef void(APIENTRY *MYPFNGLGETHISTOGRAMPROC)(GLenum target, GLboolean reset,
...
typedef void(APIENTRY *MYPFNGLHISTOGRAMPROC)(GLenum target, GLsizei width,
                                             GLenum internalformat,
                                             GLboolean sink);
typedef void(APIENTRY *MYPFNGLMINMAXPROC)(GLenum target, GLenum internalformat,
                                          GLboolean sink);
...
typedef void(APIENTRY *MYPFNGLTEXIMAGE3DPROC)(GLenum target, GLint level,
                                              ...
                                              GLenum format, GLenum type,
                                              const GLvoid *pixels);
typedef void(APIENTRY *MYPFNGLTEXSUBIMAGE3DPROC)(GLenum target, GLint level,
...
typedef void(APIENTRY *MYPFNGLFOGCOORDPOINTERPROC)(GLenum type, GLsizei stride,
...
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3FPROC)(GLfloat red, GLfloat green,
                                                    GLfloat blue);
...
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3SPROC)(GLshort red, GLshort green,
                                                    GLshort blue);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3SVPROC)(const GLshort *v);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3UBPROC)(GLubyte red, GLubyte green,
                                                     GLubyte blue);
...
typedef void(APIENTRY *MYPFNGLSECONDARYCOLORPOINTERPROC)(GLint size,
                                                         GLenum type,
                                                         GLsizei stride,
                                                         const GLvoid *pointer);
...
// OpenGL version 1.5
typedef void(APIENTRY *MYPFNGLGENQUERIESPROC)(GLsizei n, GLuint *ids);
typedef void(APIENTRY *MYPFNGLDELETEQUERIESPROC)(GLsizei n, const GLuint *ids);
typedef GLboolean(APIENTRY *MYPFNGLISQUERYPROC)(GLuint id);
typedef void(APIENTRY *MYPFNGLBEGINQUERYPROC)(GLenum target, GLuint id);
typedef void(APIENTRY *MYPFNGLENDQUERYPROC)(GLenum target);
typedef void(APIENTRY *MYPFNGLGETQUERYIVPROC)(GLenum target, GLenum pname,
                                              GLint *params);
typedef void(APIENTRY *MYPFNGLGETQUERYOBJECTIVPROC)(GLuint id, GLenum pname,
                                                    GLint *params);
typedef void(APIENTRY *MYPFNGLGETQUERYOBJECTUIVPROC)(GLuint id, GLenum pname,
                                                     GLuint *params);
typedef void(APIENTRY *MYPFNGLBINDBUFFERPROC)(GLenum target, GLuint buffer);
typedef void(APIENTRY *MYPFNGLDELETEBUFFERSPROC)(GLsizei n,
                                                 const GLuint *buffers);
typedef void(APIENTRY *MYPFNGLGENBUFFERSPROC)(GLsizei n, GLuint *buffers);
typedef GLboolean(APIENTRY *MYPFNGLISBUFFERPROC)(GLuint buffer);
typedef void(APIENTRY *MYPFNGLBUFFERDATAPROC)(GLenum target, GLsizeiptr size,
                                              const GLvoid *data, GLenum usage);
typedef void(APIENTRY *MYPFNGLBUFFERSUBDATAPROC)(GLenum target, GLintptr offset,
                                                 GLsizeiptr size,
                                                 const GLvoid *data);
typedef void(APIENTRY *MYPFNGLGETBUFFERSUBDATAPROC)(GLenum target,
                                                    GLintptr offset,
                                                    GLsizeiptr size,
                                                    GLvoid *data);
typedef GLvoid *(APIENTRY *MYPFNGLMAPBUFFERPROC)(GLenum target, GLenum access);
typedef GLboolean(APIENTRY *MYPFNGLUNMAPBUFFERPROC)(GLenum target);
typedef void(APIENTRY *MYPFNGLGETBUFFERPARAMETERIVPROC)(GLenum target,
                                                        GLenum pname,
                                                        GLint *params);
typedef void(APIENTRY *MYPFNGLGETBUFFERPOINTERVPROC)(GLenum target,
                                                     GLenum pname,
                                                     GLvoid **params);
// End OpenGL version 1.5

// OpenGL version 2.0
typedef void(APIENTRY *MYPFNGLBLENDEQUATIONSEPARATEPROC)(GLenum modeRGB,
                                                         GLenum modeAlpha);
typedef void(APIENTRY *MYPFNGLDRAWBUFFERSPROC)(GLsizei n, const GLenum *bufs);
typedef void(APIENTRY *MYPFNGLSTENCILOPSEPARATEPROC)(GLenum face, GLenum sfail,
                                                     GLenum dpfail,
                                                     GLenum dppass);
typedef void(APIENTRY *MYPFNGLSTENCILFUNCSEPARATEPROC)(GLenum frontfunc,
                                                       GLenum backfunc,
                                                       GLint ref, GLuint mask);
typedef void(APIENTRY *MYPFNGLSTENCILMASKSEPARATEPROC)(GLenum face,
                                                       GLuint mask);
typedef void(APIENTRY *MYPFNGLATTACHSHADERPROC)(GLuint program, GLuint shader);
typedef void(APIENTRY *MYPFNGLBINDATTRIBLOCATIONPROC)(GLuint program,
                                                      GLuint index,
                                                      const GLchar *name);
typedef void(APIENTRY *MYPFNGLCOMPILESHADERPROC)(GLuint shader);
typedef GLuint(APIENTRY *MYPFNGLCREATEPROGRAMPROC)(void);
typedef GLuint(APIENTRY *MYPFNGLCREATESHADERPROC)(GLenum type);
typedef void(APIENTRY *MYPFNGLDELETEPROGRAMPROC)(GLuint program);
typedef void(APIENTRY *MYPFNGLDELETESHADERPROC)(GLuint shader);
typedef void(APIENTRY *MYPFNGLDETACHSHADERPROC)(GLuint program, GLuint shader);
typedef void(APIENTRY *MYPFNGLDISABLEVERTEXATTRIBARRAYPROC)(GLuint index);
typedef void(APIENTRY *MYPFNGLENABLEVERTEXATTRIBARRAYPROC)(GLuint index);
typedef void(APIENTRY *MYPFNGLGETACTIVEATTRIBPROC)(GLuint program, GLuint index,
                                                   GLsizei bufSize,
                                                   GLsizei *length, GLint *size,
                                                   GLenum *type, GLchar *name);
typedef void(APIENTRY *MYPFNGLGETACTIVEUNIFORMPROC)(
    GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLint *size,
    GLenum *type, GLchar *name);
typedef void(APIENTRY *MYPFNGLGETATTACHEDSHADERSPROC)(GLuint program,
                                                      GLsizei maxCount,
                                                      GLsizei *count,
                                                      GLuint *obj);
typedef GLint(APIENTRY *MYPFNGLGETATTRIBLOCATIONPROC)(GLuint program,
                                                      const GLchar *name);
typedef void(APIENTRY *MYPFNGLGETPROGRAMIVPROC)(GLuint program, GLenum pname,
                                                GLint *params);
typedef void(APIENTRY *MYPFNGLGETPROGRAMINFOLOGPROC)(GLuint program,
                                                     GLsizei bufSize,
                                                     GLsizei *length,
                                                     GLchar *infoLog);
typedef void(APIENTRY *MYPFNGLGETSHADERIVPROC)(GLuint shader, GLenum pname,
                                               GLint *params);
typedef void(APIENTRY *MYPFNGLGETSHADERINFOLOGPROC)(GLuint shader,
                                                    GLsizei bufSize,
                                                    GLsizei *length,
                                                    GLchar *infoLog);
typedef void(APIENTRY *MYPFNGLGETSHADERSOURCEPROC)(GLuint shader,
                                                   GLsizei bufSize,
                                                   GLsizei *length,
                                                   GLchar *source);
typedef GLint(APIENTRY *MYPFNGLGETUNIFORMLOCATIONPROC)(GLuint program,
                                                       const GLchar *name);
typedef void(APIENTRY *MYPFNGLGETUNIFORMFVPROC)(GLuint program, GLint location,
                                                GLfloat *params);
typedef void(APIENTRY *MYPFNGLGETUNIFORMIVPROC)(GLuint program, GLint location,
                                                GLint *params);
typedef void(APIENTRY *MYPFNGLGETVERTEXATTRIBDVPROC)(GLuint index, GLenum pname,
                                                     GLdouble *params);
typedef void(APIENTRY *MYPFNGLGETVERTEXATTRIBFVPROC)(GLuint index, GLenum pname,
                                                     GLfloat *params);
typedef void(APIENTRY *MYPFNGLGETVERTEXATTRIBIVPROC)(GLuint index, GLenum pname,
                                                     GLint *params);
typedef void(APIENTRY *MYPFNGLGETVERTEXATTRIBPOINTERVPROC)(GLuint index,
                                                           GLenum pname,
                                                           GLvoid **pointer);
typedef GLboolean(APIENTRY *MYPFNGLISPROGRAMPROC)(GLuint program);
typedef GLboolean(APIENTRY *MYPFNGLISSHADERPROC)(GLuint shader);
typedef void(APIENTRY *MYPFNGLLINKPROGRAMPROC)(GLuint program);
typedef void(APIENTRY *MYPFNGLSHADERSOURCEPROC)(GLuint shader, GLsizei count,
                                                const GLchar **string,
                                                const GLint *length);
typedef void(APIENTRY *MYPFNGLUSEPROGRAMPROC)(GLuint program);
typedef void(APIENTRY *MYPFNGLUNIFORM1FPROC)(GLint location, GLfloat v0);
typedef void(APIENTRY *MYPFNGLUNIFORM2FPROC)(GLint location, GLfloat v0,
                                             GLfloat v1);
typedef void(APIENTRY *MYPFNGLUNIFORM3FPROC)(GLint location, GLfloat v0,
                                             GLfloat v1, GLfloat v2);
typedef void(APIENTRY *MYPFNGLUNIFORM4FPROC)(GLint location, GLfloat v0,
                                             GLfloat v1, GLfloat v2,
                                             GLfloat v3);
typedef void(APIENTRY *MYPFNGLUNIFORM1IPROC)(GLint location, GLint v0);
typedef void(APIENTRY *MYPFNGLUNIFORM2IPROC)(GLint location, GLint v0,
                                             GLint v1);
typedef void(APIENTRY *MYPFNGLUNIFORM3IPROC)(GLint location, GLint v0, GLint v1,
                                             GLint v2);
typedef void(APIENTRY *MYPFNGLUNIFORM4IPROC)(GLint location, GLint v0, GLint v1,
                                             GLint v2, GLint v3);
typedef void(APIENTRY *MYPFNGLUNIFORM1FVPROC)(GLint location, GLsizei count,
                                              const GLfloat *value);
typedef void(APIENTRY *MYPFNGLUNIFORM2FVPROC)(GLint location, GLsizei count,
                                              const GLfloat *value);
typedef void(APIENTRY *MYPFNGLUNIFORM3FVPROC)(GLint location, GLsizei count,
                                              const GLfloat *value);
typedef void(APIENTRY *MYPFNGLUNIFORM4FVPROC)(GLint location, GLsizei count,
                                              const GLfloat *value);
typedef void(APIENTRY *MYPFNGLUNIFORM1IVPROC)(GLint location, GLsizei count,
                                              const GLint *value);
typedef void(APIENTRY *MYPFNGLUNIFORM2IVPROC)(GLint location, GLsizei count,
                                              const GLint *value);
typedef void(APIENTRY *MYPFNGLUNIFORM3IVPROC)(GLint location, GLsizei count,
                                              const GLint *value);
typedef void(APIENTRY *MYPFNGLUNIFORM4IVPROC)(GLint location, GLsizei count,
                                              const GLint *value);
typedef void(APIENTRY *MYPFNGLUNIFORMMATRIX2FVPROC)(GLint location,
                                                    GLsizei count,
                                                    GLboolean transpose,
                                                    const GLfloat *value);
typedef void(APIENTRY *MYPFNGLUNIFORMMATRIX3FVPROC)(GLint location,
                                                    GLsizei count,
                                                    GLboolean transpose,
                                                    const GLfloat *value);
typedef void(APIENTRY *MYPFNGLUNIFORMMATRIX4FVPROC)(GLint location,
                                                    GLsizei count,
                                                    GLboolean transpose,
                                                    const GLfloat *value);
typedef void(APIENTRY *MYPFNGLVALIDATEPROGRAMPROC)(GLuint program);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB1DPROC)(GLuint index, GLdouble x);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB1DVPROC)(GLuint index,
                                                   const GLdouble *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB1FPROC)(GLuint index, GLfloat x);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB1FVPROC)(GLuint index,
                                                   const GLfloat *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB1SPROC)(GLuint index, GLshort x);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB1SVPROC)(GLuint index,
                                                   const GLshort *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB2DPROC)(GLuint index, GLdouble x,
                                                  GLdouble y);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB2DVPROC)(GLuint index,
                                                   const GLdouble *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB2FPROC)(GLuint index, GLfloat x,
                                                  GLfloat y);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB2FVPROC)(GLuint index,
                                                   const GLfloat *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB2SPROC)(GLuint index, GLshort x,
                                                  GLshort y);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB2SVPROC)(GLuint index,
                                                   const GLshort *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB3DPROC)(GLuint index, GLdouble x,
                                                  GLdouble y, GLdouble z);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB3DVPROC)(GLuint index,
                                                   const GLdouble *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB3FPROC)(GLuint index, GLfloat x,
                                                  GLfloat y, GLfloat z);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB3FVPROC)(GLuint index,
                                                   const GLfloat *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB3SPROC)(GLuint index, GLshort x,
                                                  GLshort y, GLshort z);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB3SVPROC)(GLuint index,
                                                   const GLshort *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4NBVPROC)(GLuint index,
                                                    const GLbyte *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4NIVPROC)(GLuint index,
                                                    const GLint *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4NSVPROC)(GLuint index,
                                                    const GLshort *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4NUBPROC)(GLuint index, GLubyte x,
                                                    GLubyte y, GLubyte z,
                                                    GLubyte w);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4NUBVPROC)(GLuint index,
                                                     const GLubyte *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4NUIVPROC)(GLuint index,
                                                     const GLuint *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4NUSVPROC)(GLuint index,
                                                     const GLushort *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4BVPROC)(GLuint index,
                                                   const GLbyte *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4DPROC)(GLuint index, GLdouble x,
                                                  GLdouble y, GLdouble z,
                                                  GLdouble w);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4DVPROC)(GLuint index,
                                                   const GLdouble *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4FPROC)(GLuint index, GLfloat x,
                                                  GLfloat y, GLfloat z,
                                                  GLfloat w);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4FVPROC)(GLuint index,
                                                   const GLfloat *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4IVPROC)(GLuint index,
                                                   const GLint *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4SPROC)(GLuint index, GLshort x,
                                                  GLshort y, GLshort z,
                                                  GLshort w);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4SVPROC)(GLuint index,
                                                   const GLshort *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4UBVPROC)(GLuint index,
                                                    const GLubyte *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4UIVPROC)(GLuint index,
                                                    const GLuint *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4USVPROC)(GLuint index,
                                                    const GLushort *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIBPOINTERPROC)(GLuint index, GLint size,
                                                       GLenum type,
...
typedef void(APIENTRY *MYPFNGLGETCOLORTABLEPARAMETERIVEXTPROC)(GLenum target,
                                                               GLenum pname,
                                                               GLint *params);
typedef void(APIENTRY *MYPFNGLGETCOLORTABLEPARAMETERFVEXTPROC)(GLenum target,
                                                               GLenum pname,
                                                               GLfloat *params);
...
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD1SVARBPROC)(GLenum target,
                                                       const GLshort *v);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD2DARBPROC)(GLenum target, GLdouble s,
                                                      GLdouble t);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD2DVARBPROC)(GLenum target,
                                                       const GLdouble *v);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD2FARBPROC)(GLenum target, GLfloat s,
                                                      GLfloat t);
...
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD2IVARBPROC)(GLenum target,
                                                       const GLint *v);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD2SARBPROC)(GLenum target, GLshort s,
                                                      GLshort t);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD2SVARBPROC)(GLenum target,
                                                       const GLshort *v);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD3DARBPROC)(GLenum target, GLdouble s,
                                                      GLdouble t, GLdouble r);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD3DVARBPROC)(GLenum target,
                                                       const GLdouble *v);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD3FARBPROC)(GLenum target, GLfloat s,
                                                      GLfloat t, GLfloat r);
...
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD3IVARBPROC)(GLenum target,
                                                       const GLint *v);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD3SARBPROC)(GLenum target, GLshort s,
                                                      GLshort t, GLshort r);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD3SVARBPROC)(GLenum target,
                                                       const GLshort *v);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD4DARBPROC)(GLenum target, GLdouble s,
                                                      GLdouble t, GLdouble r,
                                                      GLdouble q);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD4DVARBPROC)(GLenum target,
                                                       const GLdouble *v);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD4FARBPROC)(GLenum target, GLfloat s,
                                                      GLfloat t, GLfloat r,
                                                      GLfloat q);
...
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD4IVARBPROC)(GLenum target,
                                                       const GLint *v);
typedef void(APIENTRY *MYPFNGLMULTITEXCOORD4SARBPROC)(GLenum target, GLshort s,
                                                      GLshort t, GLshort r,
                                                      GLshort q);
...
typedef void(APIENTRY *MYPFNGLGETCOLORTABLESGIPROC)(GLenum target,
                                                    GLenum format, GLenum type,
                                                    GLvoid *table);
typedef void(APIENTRY *MYPFNGLGETCOLORTABLEPARAMETERFVSGIPROC)(GLenum target,
                                                               GLenum pname,
                                                               GLfloat *params);
...
// GL_EXT_texture3D
typedef void(APIENTRY *MYPFNGLTEXIMAGE3DEXTPROC)(GLenum target, GLint level,
                                                 GLenum internalformat,
                                                 GLsizei width, GLsizei height,
                                                 GLsizei depth, GLint border,
                                                 GLenum format, GLenum type,
...
typedef void(APIENTRY *MYPFNGLGETVERTEXATTRIBIVNVPROC)(GLuint index,
                                                       GLenum pname,
                                                       GLint *params);
typedef void(APIENTRY *MYPFNGLGETVERTEXATTRIBPOINTERVNVPROC)(GLuint index,
                                                             GLenum pname,
                                                             GLvoid **pointer);
...
typedef void(APIENTRY *MYPFNGLPROGRAMPARAMETER4DNVPROC)(GLenum target,
                                                        GLuint index,
...
typedef void(APIENTRY *MYPFNGLTRACKMATRIXNVPROC)(GLenum target, GLuint address,
                                                 GLenum matrix,
                                                 GLenum transform);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIBPOINTERNVPROC)(GLuint index,
                                                         GLint fsize,
                                                         GLenum type,
                                                         GLsizei stride,
                                                         const GLvoid *pointer);
...
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4NSVARBPROC)(GLuint index,
                                                       const GLshort *v);
typedef void(APIENTRY *MYPFNGLVERTEXATTRIB4NUBARBPROC)(GLuint index, GLubyte x,
                                                       GLubyte y, GLubyte z,
                                                       GLubyte w);
...
typedef void(APIENTRY *MYPFNGLGETPROGRAMENVPARAMETERFVARBPROC)(GLenum target,
                                                               GLuint index,
                                                               GLfloat *params);
...
typedef void(APIENTRY *MYPFNGLGETPROGRAMIVARBPROC)(GLenum target, GLenum pname,
                                                   GLint *params);
...
typedef void(APIENTRY *MYPFNGLGETVERTEXATTRIBIVARBPROC)(GLuint index,
                                                        GLenum pname,
                                                        GLint *params);
typedef void(APIENTRY *MYPFNGLGETVERTEXATTRIBPOINTERVARBPROC)(GLuint index,
                                                              GLenum pname,
                                                              GLvoid **pointer);
...
// EXT_secondary_color
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3BEXTPROC)(GLbyte red, GLbyte green,
                                                       GLbyte blue);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3BVEXTPROC)(const GLbyte *v);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3DEXTPROC)(GLdouble red,
                                                       GLdouble green,
                                                       GLdouble blue);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3DVEXTPROC)(const GLdouble *v);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3FEXTPROC)(GLfloat red,
                                                       GLfloat green,
                                                       GLfloat blue);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3FVEXTPROC)(const GLfloat *v);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3IEXTPROC)(GLint red, GLint green,
                                                       GLint blue);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3IVEXTPROC)(const GLint *v);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3SEXTPROC)(GLshort red,
                                                       GLshort green,
                                                       GLshort blue);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3SVEXTPROC)(const GLshort *v);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3UBEXTPROC)(GLubyte red,
                                                        GLubyte green,
                                                        GLubyte blue);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3UBVEXTPROC)(const GLubyte *v);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3UIEXTPROC)(GLuint red,
                                                        GLuint green,
                                                        GLuint blue);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3UIVEXTPROC)(const GLuint *v);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3USEXTPROC)(GLushort red,
                                                        GLushort green,
                                                        GLushort blue);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLOR3USVEXTPROC)(const GLushort *v);
typedef void(APIENTRY *MYPFNGLSECONDARYCOLORPOINTEREXTPROC)(
    GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);

// ARB_vertex_buffer_object
typedef void(APIENTRY *MYPFNGLBINDBUFFERARBPROC)(GLenum target, GLuint buffer);
typedef void(APIENTRY *MYPFNGLDELETEBUFFERSARBPROC)(GLsizei n,
                                                    const GLuint *buffers);
typedef void(APIENTRY *MYPFNGLGENBUFFERSARBPROC)(GLsizei n, GLuint *buffers);
typedef GLboolean(APIENTRY *MYPFNGLISBUFFERARBPROC)(GLuint buffer);
typedef void(APIENTRY *MYPFNGLBUFFERDATAARBPROC)(GLenum target,
                                                 GLsizeiptrARB size,
                                                 const GLvoid *data,
                                                 GLenum usage);
typedef void(APIENTRY *MYPFNGLBUFFERSUBDATAARBPROC)(GLenum target,
                                                    GLintptrARB offset,
                                                    GLsizeiptrARB size,
                                                    const GLvoid *data);
typedef void(APIENTRY *MYPFNGLGETBUFFERSUBDATAARBPROC)(GLenum target,
                                                       GLintptrARB offset,
                                                       GLsizeiptrARB size,
                                                       GLvoid *data);
typedef GLvoid *(APIENTRY *MYPFNGLMAPBUFFERARBPROC)(GLenum target,
                                                    GLenum access);
typedef GLboolean(APIENTRY *MYPFNGLUNMAPBUFFERARBPROC)(GLenum target);
typedef void(APIENTRY *MYPFNGLGETBUFFERPARAMETERIVARBPROC)(GLenum target,
                                                           GLenum pname,
                                                           GLint *params);
typedef void(APIENTRY *MYPFNGLGETBUFFERPOINTERVARBPROC)(GLenum target,
                                                        GLenum pname,
                                                        GLvoid **params);
...
typedef BOOL(WINAPI *MYPFNWGLGETPIXELFORMATATTRIBIVARBPROC)(
    HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes,
    const int *piAttributes, int *piValues);
typedef BOOL(WINAPI *MYPFNWGLGETPIXELFORMATATTRIBFVARBPROC)(
    HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes,
    const int *piAttributes, FLOAT *pfValues);
typedef BOOL(WINAPI *MYPFNWGLCHOOSEPIXELFORMATARBPROC)(
    HDC hdc, const int *piAttribIList, const FLOAT *pfAttribFList,
    UINT nMaxFormats, int *piFormats, UINT *nNumFormats);
// End WGL_ARB_pixel_format

// WGL_ARB_pbuffer
typedef HPBUFFERARB(WINAPI *MYPFNWGLCREATEPBUFFERARBPROC)(
    HDC hDC, int iPixelFormat, int iWidth, int iHeight,
    const int *piAttribList);
typedef HDC(WINAPI *MYPFNWGLGETPBUFFERDCARBPROC)(HPBUFFERARB hPbuffer);
typedef int(WINAPI *MYPFNWGLRELEASEPBUFFERDCARBPROC)(HPBUFFERARB hPbuffer,
                                                     HDC hDC);
typedef BOOL(WINAPI *MYPFNWGLDESTROYPBUFFERARBPROC)(HPBUFFERARB hPbuffer);
typedef BOOL(WINAPI *MYPFNWGLQUERYPBUFFERARBPROC)(HPBUFFERARB hPbuffer,
                                                  int iAttribute, int *piValue);
// End WGL_ARB_pbuffer

// WGL_ARB_render_texture
typedef BOOL(WINAPI *MYPFNWGLBINDTEXIMAGEARBPROC)(HPBUFFERARB hPbuffer,
                                                  int iBuffer);
typedef BOOL(WINAPI *MYPFNWGLRELEASETEXIMAGEARBPROC)(HPBUFFERARB hPbuffer,
                                                     int iBuffer);
typedef BOOL(WINAPI *MYPFNWGLSETPBUFFERATTRIBARBPROC)(HPBUFFERARB hPbuffer,
                                                      const int *piAttribList);
// End WGL_ARB_render_texture

// WGL_ARB_extensions_string
typedef const char *(WINAPI *MYPFNWGLGETEXTENSIONSSTRINGARBPROC)(HDC hdc);
