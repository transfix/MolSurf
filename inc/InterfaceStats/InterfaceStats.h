...
public:
  ...
  int getNumInterfaceResidues() {
    return getNumPolarResidue() + getNumNonPolarResidue();
  }
  int getNumInterfaceResidues(int stc) {
    return numPolarResidue[stc] + numNonPolarResidue[stc];
  }
  ...
  int getNumNonPolarResidue() {
    return numNonPolarResidue[0] + numPolarResidue[1];
  }
