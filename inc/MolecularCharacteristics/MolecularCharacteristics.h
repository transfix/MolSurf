...
public:
  MolecularCharacteristics(PDBParser::GroupOfAtoms *molecule,
                           SimpleVolumeData *electrostatics,
                           int numberOfSpheres, float *activeSite,
                           double *radii, char *inputGOAFileName,
                           char *inputElecVolumeFileName);
  virtual ~MolecularCharacteristics();
  bool getMoleculeCharacteristics(
  ...
  bool getAreaVolume(double *area, double *volume, double *areaInSphere,
                     double *volumeInSphere);
...
protected:
  ...
  bool getNumberOfAtoms(int *numberOfAtoms, float *point, double radius,
                        PDBParser::GroupOfAtoms *molecule);
  bool getNumberOfChargedAtoms(int *numberOfHydrophobicAtoms,
                               int *numberOfHydrophilicAtoms,
                               PDBParser::GroupOfAtoms *molecule);
  bool getNumberOfChargedAtoms(int *numberOfHydrophobicAtoms,
                               int *numberOfHydrophilicAtoms, float *point,
                               double radius,
                               PDBParser::GroupOfAtoms *molecule);
  bool zeroOutVolumeShell(SimpleVolumeData *sData, float *center, double radius,
                          char *filename);
