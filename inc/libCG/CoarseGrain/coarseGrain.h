...
private:
  ...
  void getBoundingBox(GroupOfAtoms *groupOfBeads, double cutoff, int *Min,
                      int *Max);
  void getBeadRange(int *min, int *max, double cutoff,
                    GroupOfAtoms *groupOfBeads, IndexRange *beadRamge);
  void getResidueEnd(GroupOfAtoms *groupOfBeads, int *residueEnd);
  void setupLinearSystem(double *A, double *b, GroupOfAtoms *groupOfBeads,
                         IndexRange *beadRange, IndexRange *atomRange);
  void setupLinearSystem2bead(double *A, double *b, GroupOfAtoms *groupOfBeads,
                              IndexRange *beadRange, IndexRange *atomRange,
                              double *Q);
  void setupLinearSystemAnybead2(double *A, double *b,
                                 GroupOfAtoms *groupOfBeads,
                                 IndexRange *beadRange, IndexRange *atomRange,
                                 double *Q, int *residueEnd, int *min,
                                 int *max);
  void setupLinearSystemAnybead1(double *A, double *b,
                                 GroupOfAtoms *groupOfBeads,
                                 IndexRange *beadRange, IndexRange *atomRange,
                                 double *Q, int *residueEnd);
  double getDistanceSum(int M, int *Mmin, int *Mmax,
                        GroupOfAtoms *groupOfBeads);
  double getDistanceSum(int i, int j, int *imin, int *imax, int *jmin,
                        int *jmax, GroupOfAtoms *groupOfBeads);
  double getyDistanceSum(int M, int *Mmin, int *Mmax,
                         GroupOfAtoms *groupOfBeads, IndexRange *atomRange);
  double getYk(int kx, int ky, int kz, GroupOfAtoms *goa,
  ...
  void assignCharge(GroupOfAtoms *groupOfBeads, double *b, double *Q,
                    int *residueEnd);
  void check(GroupOfAtoms *groupOfBeads, int *min, int *max,
             IndexRange *beadRange, IndexRange *atomRange);
