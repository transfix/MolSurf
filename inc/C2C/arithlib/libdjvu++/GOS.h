...
/** @name GOS.h
    ...
    (\Ref{GOS::is_file}, \Ref{GOS::is_dir}), for manipulating file and directory
   names
    ...
    @version
    #$Id: GOS.h,v 1.1.1.1 2008/06/06 19:42:10 wzhao Exp $#
*/
//@{
...
#include <C2C/arithlib/libdjvu++/GString.h>
...
public:
  ...
  /** Returns a URL for accessing the file #filename#. This function normally
      ...
      #"Microsoft"#. */
  static GString filename_to_url(const char *filename,
