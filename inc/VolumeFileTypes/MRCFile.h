...
protected:
  MRCFile();
  int finite(float f);
  bool readHeader(FILE *fp, int fileSize, bool *swap,
                  SimpleVolumeData *simpleVolumeData);
  bool checkHeader(MrcHeader &header, unsigned int fileSize);
  void swapHeader(MrcHeader &header);
  bool interpretOldHeader(MrcHeader &header, unsigned int fileSize,
                          SimpleVolumeData *simpleVolumeData);
  bool interpretNewHeader(MrcHeader &header, unsigned int fileSize,
                          SimpleVolumeData *simpleVolumeData);
