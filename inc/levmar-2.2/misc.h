...
/* common prefix for BLAS subroutines. Leave undefined in case of no prefix. You
 * might also need to modify LM_BLAS_PREFIX below */
/* f2c'd BLAS */
...
// #define LM_BLAS_SUFFIX  // define empty if a f2c_ or cblas_ prefix was
// defined for LM_BLAS_PREFIX above
...
extern void sfdif_forw_jac_approx(void (*func)(float *p, float *hx, int m,
                                               int n, void *adata),
                                  float *p, float *hx, float *hxx, float delta,
                                  float *jac, int m, int n, void *adata);
extern void dfdif_forw_jac_approx(void (*func)(double *p, double *hx, int m,
                                               int n, void *adata),
                                  double *p, double *hx, double *hxx,
                                  double delta, double *jac, int m, int n,
                                  void *adata);

/* central finite differences */
extern void sfdif_cent_jac_approx(void (*func)(float *p, float *hx, int m,
                                               int n, void *adata),
                                  float *p, float *hxm, float *hxp, float delta,
                                  float *jac, int m, int n, void *adata);
extern void dfdif_cent_jac_approx(void (*func)(double *p, double *hx, int m,
                                               int n, void *adata),
                                  double *p, double *hxm, double *hxp,
                                  double delta, double *jac, int m, int n,
                                  void *adata);
